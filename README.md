...
```
java -Dspring.profiles.active=production -jar ./target/bootifyexample-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=ru.ddc/bootifyexample
```
